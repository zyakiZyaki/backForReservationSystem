...
export interface ApiCheckCheck extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    cleaning: Attribute.Boolean & Attribute.DefaultTo<false>;
    meet: Attribute.Boolean;
    person: Attribute.String;
    checkIn: Attribute.String;
...
export interface ApiRoomRoom extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    roomId: Attribute.Integer;
    interName: Attribute.String;
    prices: Attribute.Component<'prices.price'>;
    index: Attribute.Integer;
    longTime: Attribute.Boolean & Attribute.DefaultTo<false>;
    about: Attribute.Text;
    url: Attribute.String;
    photos: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
    person: Attribute.Integer;
    tv: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
